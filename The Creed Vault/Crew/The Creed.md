...
hold: strong
coin: 2
reputation-type: Professional
hunting-grounds: Brightstone
---
# The Creed

Murder-focused **Assassins** crew ("Killers for hire," p. 99). Created in [[Session 0 - 2026-06-10]].

## Crew sheet

- **Tier 0**, strong hold, **2 coin**
- Reputation: **Professional**
- Favored operation: **Murder** — "an obvious killing that sends a message" (p. 100)
...
[[Brightstone]]. We paid 1 coin to the Bluecoats to have our presence accepted. Book caution still applies: most engagement rolls there suffer -1d from heavy patrols, and ops against nobility are hostile turf for heat (p. 259).
...
**[[Irimina]], a vicious noble** — potential patron (p. 100).

## Crew XP trigger

Earn xp when you execute a successful accident, disappearance, murder, or ransom operation (p. 99).
...
- Death is extra trouble in Duskwall: spirit bells and vengeful ghosts — "Be prepared!" (p. 99). Crow's Veil covers the heat side.
- Future upgrade candidate: **Ironhook Contacts** — effective Tier +1 in prison (p. 100); synergy with Laudius' backstory.
- Other crew contacts available (p. 100): Trev (gang boss), Lydra (deal broker), Karlos (bounty hunter), Exeter (Spirit Warden), Sevoy (merchant lord)
